...
T('${hassounData.location}',640,39,190,18,'#0C555E',700),T('${hassounData.dateLabel}',640,66,210,13,'#9AA7A4',500),T('${hassounData.hijriDate}',640,87,210,13,'#10BCA8',600),T('${hassounData.nextPrayer.name}',76,188,300,43,'#FFFFFF',700),T('${hassounData.nextPrayer.arabicName}',76,247,300,27,'#FFFFFF',700),T('${hassounData.nextPrayer.displayTime}',76,291,250,27,'#FFFFFF',700),T('${hassounData.nextPrayer.timeUntil}',120,338,205,17,'#FFFFFF',700),T('${hassounData.dateLabel}',612,180,270,18,'#0D5960',700),T('${hassounData.hijriDate}',612,209,245,14,'#12B6A2',500),T('${hassounData.eventName}',612,311,230,19,'#0D5960',700),T('${hassounData.eventWhen}',612,341,210,14,'#7B8785',500)
]}]}};
