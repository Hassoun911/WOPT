...
export default function App({ onOpenEmailAlerts }: AppProps) {
  ...
  const homeScreen = (
    <ScrollView style={styles.flex} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.sectionHeadingRow}><Text style={styles.sectionTitle}>{locale === "ar" ? "جدول اليوم" : "Today’s Schedule"}</Text><Text style={styles.sectionMeta}>🕋 {locale === "ar" ? "٥ صلوات" : "5 prayers"}</Text></View>
...
const styles = StyleSheet.create({
  ...
  sectionHeadingRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 23, marginBottom: 10 }, sectionTitle: { color: "#173f35", fontSize: 19, fontWeight: "900" }, sectionMeta: { color: "#77837e", fontSize: 10, fontWeight: "700" }, prayerList: { backgroundColor: "#fff", borderRadius: 22, borderWidth: 1, borderColor: "#dfddd5", overflow: "hidden" }, prayerRow: { minHeight: 67, flexDirection: "row", alignItems: "center", paddingHorizontal: 13, borderBottomWidth: 1, borderBottomColor: "#efede8" }, prayerRowActive: { backgroundColor: "#dff2e9", borderLeftWidth: 4, borderLeftColor: "#0b654f" }, prayerIconWrap: { width: 39, height: 39, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: "#f1f3ef", marginRight: 11 }, prayerIconWrapActive: { backgroundColor: "#d8eee5" }, prayerIcon: { fontSize: 20 }, prayerNameBlock: { flex: 1 }, prayerSubRow: { flexDirection: "row", alignItems: "center", gap: 6 }, tomorrowTag: { color: "#0b654f", backgroundColor: "#cce8dc", borderRadius: 99, paddingHorizontal: 6, paddingVertical: 2, fontSize: 7, fontWeight: "900", overflow: "hidden" }, prayerName: { color: "#173f35", fontSize: 14, fontWeight: "900" }, prayerOtherName: { color: "#8a9691", fontSize: 11, marginTop: 1 }, prayerTime: { color: "#173f35", fontSize: 15, fontWeight: "900" }, prayerActiveText: { color: "#0a654f" }, prayerActiveMuted: { color: "#679385" }, emptyText: { padding: 18, color: "#75827d" },
