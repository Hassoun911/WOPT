...
# Use whole-display background colors instead of the hard-coded classic background.
...
# Main gallery card gets independent width and height controls.
...
# Add independent controls for every lower prayer card.
...
# Expand defaults so the whole-screen background and card dimensions persist.
...
# Generic percent input helper for card width/height controls.
...
# Replace whole-page settings with smart background source controls.
