...
import AppSettingsDisplayLinks from "./AppSettingsDisplayLinks";
...
const legacyTvBootstrap = `(function(){
  ...
  var TVURL='/masjid-tv-legacy.html?v=${LEGACY_TV_VERSION}';
