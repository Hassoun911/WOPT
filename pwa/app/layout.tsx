...
const legacyTvBootstrap = `(function(){
  ...
  try{
    ...
    if(!isTv&&!forceWeb&&sessionStorage.getItem('hassoun-force-web')!=='1'&&localStorage.getItem(KEY)==='enabled'){
      window.location.replace('/masjid-tv-legacy.html');return;
    }
  }catch(e){}
  function ready(){
