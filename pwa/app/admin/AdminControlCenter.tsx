  ...
  return <main style={S.page}>
    ...
    <section style={S.main}>
      ...
      {view === "control" ? <>
        ...
        <Card title="Maintenance & global announcement" subtitle="Emergency app-wide controls"><div style={S.formGrid}><Toggle checked={appUi.maintenanceMode === true} label="Maintenance mode" onChange={(value) => saveAppUiPatch({ maintenanceMode: value })} /><Toggle checked={appUi.homeAnnouncementEnabled === true} label="Show global announcement" onChange={(value) => saveAppUiPatch({ homeAnnouncementEnabled: value })} /><Field label="Maintenance message (English)"><input value={String(appUi.maintenanceMessageEn || "")} onChange={(event) => setJsonDrafts((old) => ({ ...old, _maintenanceEn: event.target.value }))} onBlur={() => jsonDrafts._maintenanceEn !== undefined && saveAppUiPatch({ maintenanceMessageEn: jsonDrafts._maintenanceEn })} style={S.input} /></Field><Field label="Maintenance message (Arabic)"><input value={String(appUi.maintenanceMessageAr || "")} onChange={(event) => setJsonDrafts((old) => ({ ...old, _maintenanceAr: event.target.value }))} onBlur={() => jsonDrafts._maintenanceAr !== undefined && saveAppUiPatch({ maintenanceMessageAr: jsonDrafts._maintenanceAr })} style={S.input} /></Field><Field label="Announcement (English)"><textarea defaultValue={String(appUi.homeAnnouncementEn || "")} onBlur={(event) => saveAppUiPatch({ homeAnnouncementEn: event.target.value })} style={S.textarea} /></Field><Field label="Announcement (Arabic)"><textarea defaultValue={String(appUi.homeAnnouncementAr || "")} onBlur={(event) => saveAppUiPatch({ homeAnnouncementAr: event.target.value })} style={S.textarea} /></Field></div></Card>
