...
export default function AdminControlCenter() {
  ...
  return <main style={S.page}>
    <aside style={S.sidebar}>
      <div style={S.sideBrand}><img src="../assets/hassoun-logo.png" alt="Hassoun" style={{ width: 42, height: 42, objectFit: "contain" }} /><div><div style={S.eyebrow}>HASSOUN</div><strong>Admin CRM</strong></div></div>
